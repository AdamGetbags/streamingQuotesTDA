...
async def read_stream():
    ...
    stream_client.add_level_one_forex_handler(print_message)
    await stream_client.level_one_forex_subs(['USD/JPY'])

    while True:
        await stream_client.handle_message()
        
async def close_stream():
    await stream_client.level_one_forex_unsubs(['USD/JPY'])
